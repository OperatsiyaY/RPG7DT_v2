...
//=============================================================================
class RGPBackFlashEmitter extends Emitter;
...
defaultproperties
{
    ...
    // DisableDGV(1)=1
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitterDT4
         ...
         MaxParticles=1
		 StartLocationRange=(X=(Min=-75.000000,Max=-75.000000),Y=(Min=0.000000,Max=0.000000))
     ...
     End Object
     Emitters(0)=MeshEmitter'RPG7DT_v2.RGPBackFlashEmitter.MeshEmitterDT4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitterDT24
         ...
         Texture=Texture'RPG7DTv2_A.Effects.Smoke6'
         SecondsBeforeInactive=0.000000
     ...
     End Object
	 Emitters(2)=SpriteEmitter'RPG7DT_v2.RGPBackFlashEmitter.SpriteEmitterDT24'
